  ...
  "flex items-center gap-2 rounded-md text-xs/relaxed shadow-none",
  {
    variants: {
      size: {
        ...
        sm: "gap-1",
        composer:
          "h-7 gap-1.5 px-2 text-compact leading-none [&_svg:not([class*='size-'])]:size-3.5",
