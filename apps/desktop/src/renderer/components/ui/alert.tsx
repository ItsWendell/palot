...
const alertVariants = cva(
  "group/alert relative grid w-full gap-0.5 rounded-lg border bg-card/90 px-2 py-1.5 text-left text-sm/relaxed shadow-sm backdrop-blur-xl supports-[backdrop-filter]:bg-card/80 has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-1.5 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
