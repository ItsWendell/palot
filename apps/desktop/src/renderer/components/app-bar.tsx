...
export function AppBar() {
	...
	return (
		<div
			data-slot="app-bar"
			className="relative z-30 flex shrink-0 items-center border-b border-border/50 pl-3 pr-3 transition-[padding-left] duration-250 ease-in-out group-data-[state=collapsed]/sidebar-wrapper:pl-[var(--window-controls-inset)]"
			style={{
		...
		>
			...
			<div className="flex min-w-0 flex-1 items-center">{pageContent}</div>
		</div>
	)
}
