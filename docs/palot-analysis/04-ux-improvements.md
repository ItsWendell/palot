# UX Improvements for Palot

> User experience workflow improvements — how Palot could improve the end-to-end experience of working with AI coding agents.
...
- Suggestion prompts on home screen (Palot has these)
...
**Palot's DESIGN.md envisions this but it's not implemented:**
