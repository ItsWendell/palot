# Feature Parity Roadmap for Palot

> Prioritized roadmap to close the most impactful gaps between Palot and OpenCode TUI/Desktop.

## Prioritization Criteria

- **User impact**: How many users are affected and how severely
- **Trust/Safety**: Features needed for users to trust the agent
- **Differentiation**: Features that make Palot unique, not just OpenCode-in-a-window
...
> **Goal:** Make Palot trustworthy for daily use. Users must be able to see what the agent is doing before approving.
...
> **Goal:** Add the review and code browsing capabilities that make Palot a complete workspace.
...
> **Goal:** Let users customize Palot to their preferences.
...
> **Goal:** Build features that set Palot apart from OpenCode.
...
- **Impact:** Palot's core differentiator as a "mission control"
- **Effort:** High
