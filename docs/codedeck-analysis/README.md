# Codedeck Analysis: Comparison with OpenCode TUI & Desktop

> **Date:** February 8, 2026
> **Scope:** Deep feature-by-feature analysis of Codedeck vs OpenCode TUI and OpenCode Desktop

## Documents

| Document                                                   | Description                                                         |
| ---------------------------------------------------------- | ------------------------------------------------------------------- |
| [Feature Gaps](./01-feature-gaps.md)                       | Features present in OpenCode TUI/Desktop that Codedeck is missing   |
| [Codedeck Strengths](./02-codedeck-strengths.md)           | Areas where Codedeck is better than or differentiated from OpenCode |
| [UI Improvements](./03-ui-improvements.md)                 | Specific UI improvements Codedeck could make                        |
